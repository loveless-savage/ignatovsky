%% mode 01 of the paraxial wave equation, as derived by Erikson & Singh
function [Ex,Ey,Ez]=E01(x,y,z)
global k z0 w0;
...
% vector elements
Ex=scaleH.*y;
Ey=scaleH.*x.*(y.^2)/2./Z.^2 - scaleL.*x/2./Z.^2;
Ez=scaleH *-i.*x.*y./Z       - scaleL *-i./Z;
%Bx=1*Ey;
%By=1*Ex;
%Bz=scaleH.*-i*y./Z;
