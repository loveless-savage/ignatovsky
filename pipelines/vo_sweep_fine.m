%% show difference between Ignatovsky and MSM (off-axis sweep)
...
params = {'paramText','MSM ($\\theta=%d^\\circ$)',...
		  'drawHeader',true,'drawLineout',true,'drawLegend',false};
FieldCrossMovie(x,y,z,Exp,Eyp,Ezp,oaprange,altE={Ex,Ey,Ez},...
	renderParams=params, live=false, movieName="vo_sweep_fine");
